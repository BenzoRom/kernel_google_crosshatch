...
#define PF_WAKE_UP_IDLE 	0x02000000	/* try to wake up on an idle CPU */
#define PF_NO_SETAFFINITY	0x04000000	/* Userland is not allowed to meddle with cpus_allowed */
#define PF_MCE_EARLY		0x08000000      /* Early kill for mce process policy */
#define PF_MUTEX_TESTER 	0x10000000	/* Thread belongs to the rt mutex tester */
#define PF_FREEZER_SKIP 	0x20000000	/* Freezer should not count it as freezable */
#define PF_SUSPEND_TASK 	0x40000000      /* this thread called freeze_processes and should not be frozen */
